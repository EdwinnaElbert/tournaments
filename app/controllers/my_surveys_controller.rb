...
class MySurveysController < AppController
  ...
  private
    ...
    def survey_params
      params["survey"]["start_datetime"] = Date.strptime(params["survey"]["start_datetime"], "%d/%m/%Y") unless params["survey"]["start_datetime"].is_a?(Date) || params["survey"]["start_datetime"] == ""
      params["survey"]["end_datetime"] = Date.strptime(params["survey"]["end_datetime"], "%d/%m/%Y") unless params["survey"]["end_datetime"].is_a?(Date) || params["survey"]["end_datetime"] == ""
